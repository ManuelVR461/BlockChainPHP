...
if(!isset($_SESSION['datalogin']['w'])) $_SESSION['datalogin']['w'] = $w;
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <a class="nav-link" href="#">Wallet <span class="sr-only"></span></a>
            </li>
            <li class="nav-item">
            <a class="nav-link menus"  id="Minar" href="#"  title="Minar Todos las transacciones en MemoryPool">Minar</a>
            </li>
            <li class="nav-item">
            <a class="nav-link menus" href="#" id="listablocksminar">Transacciones sin Confirmar</a>
            </li>
            <li class="nav-item">
            ...
            <div class="row featurette">
                ...
                <div class="col-md-4 order-md-1 Formulario" style="background:#383838;">
                    <form action="" method="post" class="form" id="formAjax">
                        ...
                        <div class="form-group">
                            <label for="recipient">Wallet del Receptor:</label>
